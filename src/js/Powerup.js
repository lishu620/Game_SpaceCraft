...
Powerup.prototype.applyEffect = function () {
   ...
   if (this.myName == "speed") {
      ...
      var f = new FloatyText("加速", textX, textY);
      g_floatyText.push(f);
   }
      ...
      var f = new FloatyText("激光", textX, textY);
      g_floatyText.push(f);
   }
      ...
      var f = new FloatyText("射速提升", textX, textY);
      g_floatyText.push(f);
   }
      ...
      var f = new FloatyText("双倍伤害", textX, textY);
      g_floatyText.push(f);
   }
   else if (this.myName == "artifact_chard") {
      g_ship.myScore += 5000;

      var f = new FloatyText("外星符文 +5000", textX, textY);
      g_floatyText.push(f);
   }
   else if (this.myName == "artifact_skull") {
      g_ship.myScore += 10000;

      var f = new FloatyText("外星骷髅 +10000", textX, textY);
      g_floatyText.push(f);
   }
